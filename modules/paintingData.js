...
„praobraz pražského hradu sv. Václava“ („Das Urbild der prager St. Venzelsburg“)`,
  ...
  {imgSrc: `artworks/2.jpg`, 
    ...
    info: {
      // info about the painting
      title: `Budyšínský rukopis Kosmovy kroniky: ukázka`,
      artist: 'Kosmas',
    ...
    {imgSrc: `artworks/3.jpg`, 
      ...
      info: {
        // info about the painting
        title: `Kosmas v lipském rukopise`,
        artist: 'Neznámý',
        description: `Vyobrazení Kosmy v lipském rukopise jeho kroniky`,
        year: `14. století`,
  ...
  {imgSrc: `artworks/9.jpg`, 
    ...
    info: {
      // info about the painting
      title: `Úryvek z Kosmovi kroniky Čechů`,
      artist: 'Kosmas',
      description: `SVATOPLUK SE VRÁTIL Z POLSKA BEZ HALÉŘE, Kosmas: Kronika Čechů (kn. III., kap. 16).`,
      year: `Rok ???`,
    ...
    {imgSrc: `artworks/10.jpg`, 
      ...
      info: {
        // info about the painting
        title: `Kronikář Kosmas píše kroniku r. 1120`,
        artist: 'Jan Konůpek',
        description: `Potrebne zistit prava k uzitiu`,
